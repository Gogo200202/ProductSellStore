        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_Categories_CategoreId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsUsers", x => new { x.ItemId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ItemsUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Electrical appliances" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "Office supplies" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_CategoreId",
                table: "Items",
                column: "CategoreId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsUsers_UserId",
                table: "ItemsUsers",
                column: "UserId");
